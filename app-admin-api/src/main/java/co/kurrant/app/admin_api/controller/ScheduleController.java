...
public class ScheduleController {
    ...
    public ResponseMessage getRecommendPresetSchedule(@RequestParam String startDate, @RequestParam String endDate, @RequestParam Integer limit, @RequestParam Integer page, OffsetBasedPageRequest pageable) {
        return ResponseMessage.builder()
                .message("모든 식단을 요청했습니다.")
