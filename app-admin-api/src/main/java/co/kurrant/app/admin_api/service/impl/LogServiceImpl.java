...
public class LogServiceImpl implements LogService {
    ...
    public ItemPageableResponseDto<List<AdminLogsDto>> getLogs(Map<String, Object> parameters, OffsetBasedPageRequest pageable) {
        ...
        List<String> devices = !parameters.containsKey("devices") || parameters.get("devices").equals("") ? null : StringUtils.StringToStringList((String) parameters.get("devices"));
        ...
        Page<AdminLogs> adminLogs =  qAdminLogsRepository.findAllByFilter(LogType.ofCodes(logType), ControllerType.ofCodes(controllerType), startDate, endDate, devices,limit, page, pageable);
    ...
    public List<String> getDevices() {
        return qAdminLogsRepository.findDevices();
    }
}
