...
public interface ApplicationFormService {
    ...
    // 아파트 스팟 개설 신청 내역 수정
    void editApartmentApplicationForm(HttpServletRequest httpServletRequest, Long id, EditApartmentApplicationFormDto editApartmentApplicationFormDto);
    // 아파트 스팟 개설 신청 기타 내용 저장
    void saveApartmentApplicationFormMemo(HttpServletRequest httpServletRequest, Long id, ApartmentApplicationFormMemoDto apartmentApplicationFormMemoDto);
    // 기업 스팟 개설 신청
