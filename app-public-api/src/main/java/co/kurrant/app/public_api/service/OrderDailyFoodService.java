...
public interface OrderDailyFoodService {
    ...
    // 정기식사를 구매한다.
    BigInteger orderDailyFoods(SecurityUser securityUser, OrderItemDailyFoodByNiceReqDto orderItemDailyFoodReqDto) throws IOException, ParseException;
    // 구매 내역을 조회한다.
    ...
    // 주문 전체를 환불한다.
    void cancelOrderDailyFood(SecurityUser securityUser, BigInteger id) throws IOException, ParseException;
    // 주문 상품을 환불한다
