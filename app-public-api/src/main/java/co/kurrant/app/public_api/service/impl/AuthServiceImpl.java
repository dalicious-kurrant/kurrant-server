...
public class AuthServiceImpl implements AuthService {
    ...
    public void mailConfirm(MailMessageDto mailMessageDto, String type) throws Exception {
        ...
        switch (requiredAuth) {
            ...
            case PAYMENT_PASSWORD_CHECK -> userValidator.isEmailValid(Provider.GENERAL, mailMessageDto.getReceivers().get(0));
            case PAYMENT_PASSWORD_CREATE -> userValidator.isEmailValid(Provider.GENERAL, mailMessageDto.getReceivers().get(0));
        }
