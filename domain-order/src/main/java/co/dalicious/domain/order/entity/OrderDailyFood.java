...
@Getter
@Table(name = "order__dailyfood")
public class OrderDailyFood extends OrderItem{
    ...
    @Builder
    public OrderDailyFood(OrderStatus orderStatus, Order order, LocalDate serviceDate, Boolean check, DiningType diningType, Food food, String name, BigDecimal price, BigDecimal discountedPrice, Integer count, Integer makersDiscountedRate, Integer membershipDiscountedRate, Integer periodDiscountedRate) {
