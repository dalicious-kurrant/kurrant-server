...
import static co.dalicious.domain.order.entity.QOrderItemDailyFoodGroup.orderItemDailyFoodGroup;
    ...
    public Optional<OrderItemDailyFood> findByIdFetchOrderDailyFood(BigInteger id) {
        return Optional.ofNullable(
                queryFactory.selectFrom(orderItemDailyFood)
                        .innerJoin(orderItemDailyFood.orderItemDailyFoodGroup, orderItemDailyFoodGroup).fetchJoin()
